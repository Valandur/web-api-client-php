...
*HuskyCratesApi* | [**createCrate**](docs/Api/HuskyCratesApi.md#createcrate) | **POST** /husky-crates/crate | Create a crate
*HuskyCratesApi* | [**deleteCrate**](docs/Api/HuskyCratesApi.md#deletecrate) | **DELETE** /husky-crates/crate/{id} | Delete a crate
*HuskyCratesApi* | [**getCrate**](docs/Api/HuskyCratesApi.md#getcrate) | **GET** /husky-crates/crate/{id} | Get a crate
*HuskyCratesApi* | [**listCrates**](docs/Api/HuskyCratesApi.md#listcrates) | **GET** /husky-crates/crate | List crates
*HuskyCratesApi* | [**modifyCrate**](docs/Api/HuskyCratesApi.md#modifycrate) | **PUT** /husky-crates/crate/{id} | Change a crate
...
*MMCRestrictApi* | [**addItem**](docs/Api/MMCRestrictApi.md#additem) | **POST** /mmc-restrict/item | Add an item
*MMCRestrictApi* | [**deleteItem**](docs/Api/MMCRestrictApi.md#deleteitem) | **DELETE** /mmc-restrict/item/{id} | Delete an item
*MMCRestrictApi* | [**listItems**](docs/Api/MMCRestrictApi.md#listitems) | **GET** /mmc-restrict/item | List items
*MMCRestrictApi* | [**modifyItem**](docs/Api/MMCRestrictApi.md#modifyitem) | **PUT** /mmc-restrict/item/{id} | Modify an item
*MMCTicketsApi* | [**getTicket**](docs/Api/MMCTicketsApi.md#getticket) | **GET** /mmc-tickets/ticket/{id} | Get a ticket
*MMCTicketsApi* | [**listTickets**](docs/Api/MMCTicketsApi.md#listtickets) | **GET** /mmc-tickets/ticket | List tickets
*MMCTicketsApi* | [**modifyTicket**](docs/Api/MMCTicketsApi.md#modifyticket) | **PUT** /mmc-tickets/ticket/{id} | Modify a ticket
*MapApi* | [**getMap**](docs/Api/MapApi.md#getmap) | **GET** /map/{world}/{x}/{z} | Get a map tile
*NucleusApi* | [**createJail**](docs/Api/NucleusApi.md#createjail) | **POST** /nucleus/jail | Create a jail
*NucleusApi* | [**createKit**](docs/Api/NucleusApi.md#createkit) | **POST** /nucleus/kit | Create a kit
*NucleusApi* | [**deleteJail**](docs/Api/NucleusApi.md#deletejail) | **DELETE** /nucleus/jail/{name} | Delete a jail
*NucleusApi* | [**deleteKit**](docs/Api/NucleusApi.md#deletekit) | **DELETE** /nucleus/kit/{name} | Delete a kit
*NucleusApi* | [**getJail**](docs/Api/NucleusApi.md#getjail) | **GET** /nucleus/jail/{name} | Get a jail
*NucleusApi* | [**getKit**](docs/Api/NucleusApi.md#getkit) | **GET** /nucleus/kit/{name} | Get a kit
*NucleusApi* | [**listHomes**](docs/Api/NucleusApi.md#listhomes) | **GET** /nucleus/home/{player} | List homes
*NucleusApi* | [**listJails**](docs/Api/NucleusApi.md#listjails) | **GET** /nucleus/jail | List jails
*NucleusApi* | [**listKits**](docs/Api/NucleusApi.md#listkits) | **GET** /nucleus/kit | List kits
*NucleusApi* | [**listMail**](docs/Api/NucleusApi.md#listmail) | **GET** /nucleus/mail/{player} | List mail
*NucleusApi* | [**listMail_0**](docs/Api/NucleusApi.md#listmail_0) | **GET** /nucleus/module | List modules
*NucleusApi* | [**modifyJail**](docs/Api/NucleusApi.md#modifyjail) | **PUT** /nucleus/jail/{name} | Modify a jail
*NucleusApi* | [**modifyKit**](docs/Api/NucleusApi.md#modifykit) | **PUT** /nucleus/kit/{name} | Modify a kit
...
*UserApi* | [**getUserDetails**](docs/Api/UserApi.md#getuserdetails) | **GET** /user | Check info
