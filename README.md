...
- API version: &lt;version&gt;
- Build date: 2017-10-09T12:59:15.740+02:00
...
*HistoryApi* | [**getChat**](docs/Api/HistoryApi.md#getchat) | **GET** /history/chat | Chat History
*HistoryApi* | [**getCommands**](docs/Api/HistoryApi.md#getcommands) | **GET** /history/cmd | Command History
...
## Documentation For Models
 ...
 - [PlayerMethodResult](docs/Model/PlayerMethodResult.md)
 ...
 - [UpdateEntityRequestDamage](docs/Model/UpdateEntityRequestDamage.md)
 - [UpdatePlayerRequest](docs/Model/UpdatePlayerRequest.md)
 - [UpdatePlayerRequestDamage](docs/Model/UpdatePlayerRequestDamage.md)
 ...
 - [WorldRequest](docs/Model/WorldRequest.md)
