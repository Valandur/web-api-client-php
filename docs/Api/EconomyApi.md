...
# **getAccount**
> \Swagger\Client\Model\Account getAccount($id, $details, $accept, $pretty)
...
$apiInstance = new Swagger\Client\Api\EconomyApi(
...
try {
    $result = $apiInstance->getAccount($id, $details, $accept, $pretty);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EconomyApi->getAccount: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getCurrencies**
> \Swagger\Client\Model\Currency[] getCurrencies($details, $accept, $pretty)
...
try {
    $result = $apiInstance->getCurrencies($details, $accept, $pretty);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EconomyApi->getCurrencies: ', $e->getMessage(), PHP_EOL;
}
?>
```
