...
**location** | [**\Swagger\Client\Model\Location**](Location.md) | The current location of the entity | 
**rotation** | [**\Swagger\Client\Model\Vector3d**](Vector3d.md) | The current rotation of the entity | 
**scale** | [**\Swagger\Client\Model\Vector3d**](Vector3d.md) | The current scale of the entity | 
**type** | [**\Swagger\Client\Model\CatalogType**](CatalogType.md) | The type of entity | 
**uuid** | **string** | The unique UUID of the entity | 
**velocity** | [**\Swagger\Client\Model\Vector3d**](Vector3d.md) | The current velocity of the entity | 
