...
class RegistryApi
{
     ...
     * Get a catalog type
     *
     * @param  string $class The fully qualified classname of the catalog type (required)
     ...
     */
    public function getRegistry($class, $details = null, $accept = null, $pretty = null)
    {
        list($response) = $this->getRegistryWithHttpInfo($class, $details, $accept, $pretty);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CatalogType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getRegistryWithHttpInfo($class, $details = null, $accept = null, $pretty = null)
    {
        $returnType = '\Swagger\Client\Model\CatalogType[]';
        $request = $this->getRegistryRequest($class, $details, $accept, $pretty);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CatalogType[]',
     ...
     */
    public function getRegistryAsync($class, $details = null, $accept = null, $pretty = null)
    {
        return $this->getRegistryAsyncWithHttpInfo($class, $details, $accept, $pretty)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRegistryAsyncWithHttpInfo($class, $details = null, $accept = null, $pretty = null)
    {
        $returnType = '\Swagger\Client\Model\CatalogType[]';
        $request = $this->getRegistryRequest($class, $details, $accept, $pretty);
     ...
     */
    protected function getRegistryRequest($class, $details = null, $accept = null, $pretty = null)
    {
        // verify the required parameter 'class' is set
        if ($class === null || (is_array($class) && count($class) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $class when calling getRegistry'
            );
        }

        $resourcePath = '/registry/{class}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
