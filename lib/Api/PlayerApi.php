...
class PlayerApi
{
     ...
     */
    public function executeMethod($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        list($response) = $this->executeMethodWithHttpInfo($player, $body, $details, $accept, $pretty);
        return $response;
    }
     ...
     */
    public function executeMethodWithHttpInfo($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        $returnType = '\Swagger\Client\Model\ExecuteMethodResponse';
        $request = $this->executeMethodRequest($player, $body, $details, $accept, $pretty);
     ...
     */
    public function executeMethodAsync($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        return $this->executeMethodAsyncWithHttpInfo($player, $body, $details, $accept, $pretty)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function executeMethodAsyncWithHttpInfo($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        $returnType = '\Swagger\Client\Model\ExecuteMethodResponse';
        $request = $this->executeMethodRequest($player, $body, $details, $accept, $pretty);
     ...
     */
    protected function executeMethodRequest($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        // verify the required parameter 'player' is set
        if ($player === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $player when calling executeMethod'
            );
        }

        $resourcePath = '/player/{player}/method';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getPlayerWithHttpInfo($player, $details, $accept, $pretty);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPlayerAsync($player, $details = null, $accept = null, $pretty = null)
    {
        return $this->getPlayerAsyncWithHttpInfo($player, $details, $accept, $pretty)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPlayerRequest($player, $details = null, $accept = null, $pretty = null)
    {
        // verify the required parameter 'player' is set
        if ($player === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $player when calling getPlayer'
            );
        }

        $resourcePath = '/player/{player}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->listPlayersWithHttpInfo($details, $accept, $pretty);
        return $response;
    }

    /**
     * Operation listPlayersWithHttpInfo
     *
     * List players
     *
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPlayersAsync($details = null, $accept = null, $pretty = null)
    {
        return $this->listPlayersAsyncWithHttpInfo($details, $accept, $pretty)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listPlayersAsyncWithHttpInfo
     *
     * List players
     *
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
    ...
    /**
     * Create request for operation 'listPlayers'
     *
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     * @param  string $accept Override the &#39;Accept&#39; request header (useful for debugging your requests) (optional)
     * @param  bool $pretty Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listPlayersRequest($details = null, $accept = null, $pretty = null)
    {
     ...
     *
     * @param  string $player The uuid of the player (required)
     * @param  \Swagger\Client\Model\UpdatePlayerRequest $body body (optional)
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     * @param  string $accept Override the &#39;Accept&#39; request header (useful for debugging your requests) (optional)
     * @param  bool $pretty Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)
     *
    ...
    {
        list($response) = $this->modifyPlayerWithHttpInfo($player, $body, $details, $accept, $pretty);
        return $response;
    }

    /**
     * Operation modifyPlayerWithHttpInfo
     *
     * Modify a player
     *
     * @param  string $player The uuid of the player (required)
     * @param  \Swagger\Client\Model\UpdatePlayerRequest $body (optional)
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     * @param  string $accept Override the &#39;Accept&#39; request header (useful for debugging your requests) (optional)
     * @param  bool $pretty Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function modifyPlayerAsync($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        return $this->modifyPlayerAsyncWithHttpInfo($player, $body, $details, $accept, $pretty)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation modifyPlayerAsyncWithHttpInfo
     *
     * Modify a player
     *
     * @param  string $player The uuid of the player (required)
    ...
    /**
     * Create request for operation 'modifyPlayer'
     *
     * @param  string $player The uuid of the player (required)
     * @param  \Swagger\Client\Model\UpdatePlayerRequest $body (optional)
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function modifyPlayerRequest($player, $body = null, $details = null, $accept = null, $pretty = null)
    {
        // verify the required parameter 'player' is set
        if ($player === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $player when calling modifyPlayer'
            );
        }
