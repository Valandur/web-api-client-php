...
class RecipeApi
{
     ...
     * @return object
     */
    public function listRecipes($details = null, $accept = null, $pretty = null)
    {
        list($response) = $this->listRecipesWithHttpInfo($details, $accept, $pretty);
        return $response;
    }

    /**
     * Operation listRecipesWithHttpInfo
     *
     * List recipes
     *
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     ...
     */
    public function listRecipesWithHttpInfo($details = null, $accept = null, $pretty = null)
    {
        $returnType = 'object';
        $request = $this->listRecipesRequest($details, $accept, $pretty);
     ...
     */
    public function listRecipesAsync($details = null, $accept = null, $pretty = null)
    {
        return $this->listRecipesAsyncWithHttpInfo($details, $accept, $pretty)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listRecipesAsyncWithHttpInfo
     *
     * List recipes
     *
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listRecipesAsyncWithHttpInfo($details = null, $accept = null, $pretty = null)
    {
        $returnType = 'object';
        $request = $this->listRecipesRequest($details, $accept, $pretty);
    ...
    /**
     * Create request for operation 'listRecipes'
     *
     * @param  bool $details Add to include additional details, omit or false otherwise (optional)
     * @param  string $accept Override the &#39;Accept&#39; request header (useful for debugging your requests) (optional)
     * @param  bool $pretty Add to make the Web-API pretty print the response (useful for debugging your requests) (optional)
     ...
     */
    protected function listRecipesRequest($details = null, $accept = null, $pretty = null)
    {
