...
class WorldApi
{
    ...
    public function changeWorldWithHttpInfo($uuid, $update_world_request)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\WorldResponse', $httpHeader), $statusCode, $httpHeader);
    ...
    public function executeWorldMethodWithHttpInfo($uuid, $request)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ExecuteWorldMethodResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getWorldsWithHttpInfo($details = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\WorldsResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
