...
class TileEntityApi
{
    ...
    public function executeTileEntityMethodWithHttpInfo($world_uuid, $x, $y, $z, $request)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ExecuteTileEntityMethodResponse', $httpHeader), $statusCode, $httpHeader);
    ...
    public function getTileEntitiesWithHttpInfo($world = null, $type = null, $limit = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TileEntitiesResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getTileEntityWithHttpInfo($world_uuid, $x, $y, $z, $fields = null, $methods = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\TileEntityResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
