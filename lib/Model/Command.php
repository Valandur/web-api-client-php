...
class Command implements ModelInterface, ArrayAccess
{
     ...
     * Sets aliases
     *
     * @param string[] $aliases All the aliases that were registered for this command
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description The description provided with the command
     *
     * @return $this
     */
     ...
     * Sets help
     *
     * @param string $help Extended help information on the usage of the command
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the command, sometimes also referred to as primary alias.
     *
     * @return $this
     */
     ...
     * Sets usage
     *
     * @param string $usage A short description of the usage of this command
     *
     * @return $this
     */
