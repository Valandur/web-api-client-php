...
class Inventory implements ModelInterface, ArrayAccess
{
     ...
     * Sets capacity
     *
     * @param int $capacity The maximum capacity of the inventory (maximum number of stacks)
     *
     * @return $this
     */
     ...
     * Sets total_items
     *
     * @param int $total_items The total amount of items currently in the inventory
     *
     * @return $this
     */
