...
class BlockOperation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'min' => '\Swagger\Client\Model\Vector3i',
        'progress' => 'float',
        'status' => 'string',
        'type' => 'string',
        'uuid' => 'string',
    ...
    /**
     * Gets estimated_seconds_remaining
     *
     * @return float
     */
    public function getEstimatedSecondsRemaining()
    {
        return $this->container['estimated_seconds_remaining'];
    }

    /**
     * Sets estimated_seconds_remaining
     *
     * @param float $estimated_seconds_remaining The estimated amount of time remaining until this block operation is complete (in seconds)
     *
     * @return $this
     */
    public function setEstimatedSecondsRemaining($estimated_seconds_remaining)
    {
        $this->container['estimated_seconds_remaining'] = $estimated_seconds_remaining;
     ...
     * Sets max
     *
     * @param \Swagger\Client\Model\Vector3i $max The maximum block belonging to this operation
     *
     * @return $this
     */
     ...
     * Sets min
     *
     * @param \Swagger\Client\Model\Vector3i $min The minimum block belonging to this operation
     *
     * @return $this
     */
     ...
     * Sets progress
     *
     * @param float $progress The current progress of the block operation, from 0 (=started) to 1 (=finished)
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status The current status of the block operation
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of block operation
     *
     * @return $this
     */
     ...
     * Sets uuid
     *
     * @param string $uuid The unique UUID identifying this block operation
     *
     * @return $this
     */
     ...
     * Sets world
     *
     * @param \Swagger\Client\Model\World $world The world in which this block operation is running
     *
     * @return $this
     */
