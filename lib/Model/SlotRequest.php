 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SlotRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SlotRequest';
     ...
     * Sets slot_index
     *
     * @param int $slot_index The index of the slot to change
     *
     * @return $this
     */
     ...
     * Sets stack
     *
     * @param \Swagger\Client\Model\ItemStack $stack The ItemStack that should be in the slot. null for an empty slot
     *
     * @return $this
     */
