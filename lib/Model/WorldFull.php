 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorldFull implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorldFull';
    ...
    protected static $swaggerTypes = [
        ...
        'border' => '\Swagger\Client\Model\WorldBorder',
        ...
        'time' => 'int',
        'seed' => 'int',
        'difficulty' => '\Swagger\Client\Model\CatalogTypeDifficulty',
        'game_rules' => 'map[string,string]',
        'weather' => '\Swagger\Client\Model\CatalogTypeWeather',
        'game_mode' => '\Swagger\Client\Model\GameMode',
        'generator_type' => '\Swagger\Client\Model\CatalogTypeGeneratorType',
        'dimension_type' => '\Swagger\Client\Model\CatalogTypeDimensionType',
        'absorption' => 'double',
    ...
    protected static $swaggerFormats = [
        ...
        'name' => null,
        'uuid' => 'uuid',
        'map_features_enabled' => null,
        'border' => null,
        'spawn' => null,
        'load_on_startup' => null,
        'keep_spawn_loaded' => null,
        'allow_commands' => null,
        'generate_bonus_chests' => null,
        'time' => 'int64',
        'seed' => 'int64',
        'difficulty' => null,
        'game_rules' => null,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['map_features_enabled'] = isset($data['map_features_enabled']) ? $data['map_features_enabled'] : null;
        ...
        $this->container['generate_bonus_chests'] = isset($data['generate_bonus_chests']) ? $data['generate_bonus_chests'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['map_features_enabled'] === null) {
            $invalidProperties[] = "'map_features_enabled' can't be null";
        }
        if ($this->container['border'] === null) {
            $invalidProperties[] = "'border' can't be null";
        }
        if ($this->container['load_on_startup'] === null) {
            $invalidProperties[] = "'load_on_startup' can't be null";
        }
        if ($this->container['keep_spawn_loaded'] === null) {
            $invalidProperties[] = "'keep_spawn_loaded' can't be null";
        }
        if ($this->container['allow_commands'] === null) {
            $invalidProperties[] = "'allow_commands' can't be null";
        }
        if ($this->container['generate_bonus_chests'] === null) {
            $invalidProperties[] = "'generate_bonus_chests' can't be null";
        }
        ...
        if ($this->container['game_rules'] === null) {
            $invalidProperties[] = "'game_rules' can't be null";
        }
        if ($this->container['weather'] === null) {
            $invalidProperties[] = "'weather' can't be null";
        }
        if ($this->container['generator_type'] === null) {
            $invalidProperties[] = "'generator_type' can't be null";
        }
        if ($this->container['dimension_type'] === null) {
            $invalidProperties[] = "'dimension_type' can't be null";
        }
        ...
        if (!in_array($this->container['matter'], $allowedValues)) {
            $invalidProperties[] = sprintf(
     ...
     * Sets loaded
     *
     * @param bool $loaded True if the world is loaded, false otherwise
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this world
     *
     * @return $this
     */
     ...
     * Sets uuid
     *
     * @param string $uuid The unique UUID that identifies this world
     *
     * @return $this
     */
    ...
    /**
     * Gets map_features_enabled
     *
     * @return bool
     */
    public function getMapFeaturesEnabled()
    {
        return $this->container['map_features_enabled'];
    }

    /**
     * Sets map_features_enabled
     *
     * @param bool $map_features_enabled True if map specific features are enabled for this world, false otherwise
     *
     * @return $this
     */
    public function setMapFeaturesEnabled($map_features_enabled)
    {
        $this->container['map_features_enabled'] = $map_features_enabled;
     ...
     * Gets border
     *
     * @return \Swagger\Client\Model\WorldBorder
     */
     ...
     * Sets border
     *
     * @param \Swagger\Client\Model\WorldBorder $border The border of the world
     *
     * @return $this
     */
     ...
     *
     * @param bool $load_on_startup True if this world is loaded when the server starts, false otherwise
     *
     * @return $this
     */
     ...
     *
     * @param bool $keep_spawn_loaded True if the spawn of this world is always kept loaded, false otherwise
     *
     * @return $this
     */
     ...
     * Sets allow_commands
     *
     * @param bool $allow_commands True if commands are allowed to be executed in this world, false otherwise
     *
     * @return $this
     */
    ...
    /**
     * Gets generate_bonus_chests
     *
     * @return bool
     */
    public function getGenerateBonusChests()
    {
        return $this->container['generate_bonus_chests'];
    }

    /**
     * Sets generate_bonus_chests
     *
     * @param bool $generate_bonus_chests True if bonus chests are generated for this world, false otherwise
     *
     * @return $this
     */
    public function setGenerateBonusChests($generate_bonus_chests)
    {
        $this->container['generate_bonus_chests'] = $generate_bonus_chests;
     ...
     * Sets time
     *
     * @param int $time The current time in the world
     *
     * @return $this
     */
     ...
     * Gets difficulty
     *
     * @return \Swagger\Client\Model\CatalogTypeDifficulty
     */
     ...
     * Sets difficulty
     *
     * @param \Swagger\Client\Model\CatalogTypeDifficulty $difficulty The difficulty of the world
     *
     * @return $this
     */
     ...
     * Sets game_rules
     *
     * @param map[string,string] $game_rules A map of world rule names to values
     *
     * @return $this
     */
     ...
     * Gets weather
     *
     * @return \Swagger\Client\Model\CatalogTypeWeather
     */
     ...
     * Sets weather
     *
     * @param \Swagger\Client\Model\CatalogTypeWeather $weather The current weather in the world
     *
     * @return $this
     */
     ...
     * Gets generator_type
     *
     * @return \Swagger\Client\Model\CatalogTypeGeneratorType
     */
     ...
     * Sets generator_type
     *
     * @param \Swagger\Client\Model\CatalogTypeGeneratorType $generator_type The generator type used for this world
     *
     * @return $this
     */
     ...
     * Gets dimension_type
     *
     * @return \Swagger\Client\Model\CatalogTypeDimensionType
     */
     ...
     * Sets dimension_type
     *
     * @param \Swagger\Client\Model\CatalogTypeDimensionType $dimension_type The dimension of the world
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAxisAllowableValues();
        if (!is_null($axis) && !in_array($axis, $allowedValues)) {
    ...
    {
        $allowedValues = $this->getMatterAllowableValues();
        if (!is_null($matter) && !in_array($matter, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'matter', must be one of '%s'",
                    implode("', '", $allowedValues)
