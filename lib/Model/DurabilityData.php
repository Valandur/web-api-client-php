...
/**
 * DurabilityData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DurabilityData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DurabilityData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unbreakable'] === null) {
            $invalidProperties[] = "'unbreakable' can't be null";
        }
        if ($this->container['durability'] === null) {
            $invalidProperties[] = "'durability' can't be null";
        }
     ...
     * Sets unbreakable
     *
     * @param bool $unbreakable True if this entity is unbreakable, false otherwise
     *
     * @return $this
     */
     ...
     * Sets durability
     *
     * @param int $durability The remaining durability of this entity
     *
     * @return $this
     */
